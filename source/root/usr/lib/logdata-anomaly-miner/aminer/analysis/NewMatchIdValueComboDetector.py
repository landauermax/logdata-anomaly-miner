...
class NewMatchIdValueComboDetector(
  ...
  def __init__(
      ...
      id_path_list, min_allowed_time_diff, persistence_id='Default', 
      allow_missing_values_flag=False, auto_include_flag=False, 
...
# Combo is unknown, process and raise anomaly
  ...
  def do_persist(self):
    ...
    PersistencyUtil.store_json(
        self.persistence_file_name, self.known_values)
    self.next_persist_time = None
